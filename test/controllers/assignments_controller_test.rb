...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { end_date: @assignment.end_date, start_date: @assignment.start_date } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { end_date: @assignment.end_date, start_date: @assignment.start_date } }
